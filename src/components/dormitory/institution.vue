    ...
    <div class="institution-wrapper">
      <van-collapse :value="activeName" @change="onChange" accordion>
        <template v-for="(item, index) in institutionList">
            <van-collapse-item :title="item.name" value="查看" :name="index" :key="index">
              <chart-dormitory :dataList="item.data"/>
            </van-collapse-item>
        </template>
      </van-collapse>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      institutionList: [
        {          name: '管理规定', data: [
            { title: '大学学生公寓消防安全管理规定', content: '', imgList: [{ url: '' }] },
            { title: '教育部关于加强高等学生公寓安全管理', content: '', imgList: [{ url: '' }] },
            { title: '学生公寓内务卫生达标制度', content: '', imgList: [{ url: '' }] },
          ]        },
        {          name: '服务指南', data: [
            { title: '大学学生公寓消防安全管理规定', content: '', imgList: [{ url: '' }] },
            { title: '教育部关于加强高等学生公寓安全管理', content: '', imgList: [{ url: '' }] },
