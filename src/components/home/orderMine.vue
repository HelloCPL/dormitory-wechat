<template>
  <div class="we-bg we-padding mine-container">
    <template v-for="(item, index) in mineList">
...
export default {
  ...
  data() {
    return {
      mineIcon: require('@icon/order_mine.png'),
      mineList: [ // status 1 进行中 2 已接单 0 已结束
