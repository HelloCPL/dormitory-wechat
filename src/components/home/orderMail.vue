<template>
  <div class="we-bg we-padding mail-container">
    <template v-for="(item, index) in mailList">
...
export default {
  ...
  data() {
    return {
      mailIcon: require('@icon/order_mail.png'),
      mailList: [ // status 1 进行中 2 已接单 0 已结束
        { title: '帮忙拿快递', content: '顺便的话帮忙去XX地方拿快递，重金酬谢！！！', startPlace: '菜鸟驿站', endPlace: '北二666', startTime: '2020-02-16 12:00', endTime: '2020-02-16 13:30', money: '3', payWay: '线下支付', status: 1, remark: '' },
        { title: '帮忙拿快递', content: '顺便的话帮忙去XX地方拿快递，重金酬谢！！！', startPlace: '菜鸟驿站', endPlace: '北二666', startTime: '2020-02-16 12:00', endTime: '2020-02-16 13:30', money: '3', payWay: '线下支付', status: 1, remark: '' },
        { title: '帮忙拿快递', content: '顺便的话帮忙去XX地方拿快递，重金酬谢！！！', startPlace: '菜鸟驿站', endPlace: '北二666', startTime: '2020-02-16 12:00', endTime: '2020-02-16 13:30', money: '3', payWay: '线下支付', status: 2, remark: '' },
        { title: '帮忙拿快递', content: '顺便的话帮忙去XX地方拿快递，重金酬谢！！！', startPlace: '菜鸟驿站', endPlace: '北二666', startTime: '2020-02-16 12:00', endTime: '2020-02-16 13:30', money: '3', payWay: '线下支付', status: 0, remark: '' },
        { title: '帮忙拿快递', content: '顺便的话帮忙去XX地方拿快递，重金酬谢！！！', startPlace: '菜鸟驿站', endPlace: '北二666', startTime: '2020-02-16 12:00', endTime: '2020-02-16 13:30', money: '3', payWay: '线下支付', status: 0, remark: '' },
        { title: '帮忙拿快递', content: '顺便的话帮忙去XX地方拿快递，重金酬谢！！！', startPlace: '菜鸟驿站', endPlace: '北二666', startTime: '2020-02-16 12:00', endTime: '2020-02-16 13:30', money: '3', payWay: '线下支付', status: 2, remark: '' },
        { title: '帮忙拿快递', content: '顺便的话帮忙去XX地方拿快递，重金酬谢！！！', startPlace: '菜鸟驿站', endPlace: '北二666', startTime: '2020-02-16 12:00', endTime: '2020-02-16 13:30', money: '3', payWay: '线下支付', status: 2, remark: '' },
        { title: '帮忙拿快递', content: '顺便的话帮忙去XX地方拿快递，重金酬谢！！！', startPlace: '菜鸟驿站', endPlace: '北二666', startTime: '2020-02-16 12:00', endTime: '2020-02-16 13:30', money: '3', payWay: '线下支付', status: 1, remark: '' },
